...
public class WaypointEditor : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        for (int i = 0; i < Waypoint.Points.Length; i++)
        {
            ...
            // Create Handles
            var currentWaypointPoint = Waypoint.CurrentPosition + Waypoint.Points[i];
            var newWaypointPoint = Handles.FreeMoveHandle(currentWaypointPoint, Quaternion.identity, 0.7f,
